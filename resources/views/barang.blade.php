...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a class="nav-link  active" href="{{ route('barang') }}"><i class="bi bi-box"></i> Barang</a></li>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('barang.destroy', $datas->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">
                        @csrf
                        @method('DELETE')
