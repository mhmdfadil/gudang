...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a class="nav-link active" href="{{ route('supplier') }}"><i class="bi bi-truck"></i> Supplier</a></li>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('supplier.destroy', $datas->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus supplier ini?')">
                        @csrf
                        @method('DELETE')
